...
const Register = () => {
        ...
        onSubmit: (values) => {
            ...
            registerUser(email, password)
                .then((userCredetial) => {
                    ...
                    toast.success("Your Registaion Successfully")
                    navigate("/")
    ...
    return (
        <div className='h-screen mt-5'>
            <div className='max-w-6xl  mx-auto bg-base-300 dark:bg-gray-500'>
                <div className='flex  justify-center  px-4 md:px-0'>
                    <div className="w-full max-w-lg  p-4  rounded-md  sm:p-6 md:p-8 ">
                        <form className="space-y-4 " onSubmit={formik.handleSubmit}>
                            ...
                            <div className="text-sm dark:text-white font-medium text-gray-500 ">
